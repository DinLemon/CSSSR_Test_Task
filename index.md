...
**Проблема:** Верстка текста под заголовком "12:00 - 21:00" не соответствует макету, а именно:
...
**Фактический результат:** Верстка текста "Вникать в детали проектов" под блоком с процентами не соответствует макету и значения следующих параметров являются следующими:
...
**Фактический результат:** Верстка текста "Находить несовершенства" под блоком с процентами не соответствует макету и значения следующих параметров являются следующими:
...
**Фактический результат:** Верстка текста "Сопровождать проекты" под блоком с процентами не соответствует макету и значения следующих параметров являются следующими:
...
**Фактический результат:** Верстка текста "Работать с файлами проектов" под блоком с процентами не соответствует макету и значения следующих параметров являются следующими:
...
- Максимальная Recipient name часть в 64 символа
- Наличие символа @
- Максимальная Domain часть 248 символов
- Максимальная длина всего email-адреса 254 символа
...
11.Можно было бы добавить оповещение пользователя после отправки им формы обратной связи, чтобы пользователь видел уведомление о том, что скоро с ним свяжутся.
